...
_PRONOUNS = frozenset({"ella", "el", "él", "ellas", "ellos"})
...
class ReferenceResolver:
    def resolve(
        ...
        explicit = self._explicit_matches(
            normalized_message,
            scoped,
        )
    ...
    def _explicit_matches(
        text: str,
        candidates: tuple[EntityCandidate, ...],
    ) -> tuple[tuple[str, EntityCandidate], ...]:
