    ...
    return ProcessCatalog(
        (
            ...
            p(
                "cari.trivia.round",
                BotIdentity.CARI,
                "Publicar trivia de Cari",
                "game",
                "Crear y publicar una ronda de trivia de anime única en la comunidad",
            ...
            p(
                "cari.trivia.answer",
                BotIdentity.CARI,
                "Resolver trivia de Cari",
                "game",
                "Validar respuestas de trivia y acreditar puntos una sola vez",
                conditions=("authorized_chat", "active_round", "unique_attempt"),
                inputs=("round_id", "user_id", "answer"),
                outputs=("points_balance", "winner"),
                actions=("db.claim", "points.credit", "world.observe"),
                priority=95,
                cost=0.4,
            ),
            p(
                "cami.mystery.round",
                BotIdentity.CAMI,
                "Publicar misterio de Cami",
                "game",
                "Publicar el caso cotidiano diario de Cami y permitir una única resolución ganadora",
                conditions=("authorized_chat", "daily_round"),
                inputs=("chat_id", "day_key"),
                outputs=("round_id", "message_id"),
                actions=("db.claim", "telegram.send_message", "world.observe"),
                priority=90,
            ...
            p(
                "cami.mystery.answer",
                BotIdentity.CAMI,
                "Resolver misterio de Cami",
                "game",
                "Validar pistas y respuestas de un caso cotidiano y acreditar puntos",
                conditions=("authorized_chat", "active_round", "unique_attempt"),
                inputs=("round_id", "user_id", "answer"),
                outputs=("points_balance", "winner"),
                actions=("db.claim", "points.credit", "world.observe"),
            ...
            p(
                ...
                "security",
                "Comprobar que un nuevo integrante participa manualmente y restaurar sus permisos",
                conditions=("authorized_chat", "new_member", "bot_admin"),
                inputs=("chat_id", "user_id", "answer"),
                outputs=("verification_status",),
                actions=("telegram.restrict", "telegram.unban", "db.claim", "world.observe"),
                priority=100,
                cost=0.3,
            ),
            p(
                "chie.community.welcome",
                BotIdentity.CHIE,
                "Recibir integrante",
                "community",
                "Presentar el protocolo de bienvenida y verificación a un nuevo integrante",
                conditions=("authorized_chat", "new_member"),
                inputs=("chat_id", "user_id"),
                outputs=("message_id", "verification_id"),
                actions=("telegram.send_message", "db.create", "world.observe"),
                priority=90,
                cost=0.2,
            ),
            p(
                "chie.community.goodbye",
                BotIdentity.CHIE,
                "Despedir integrante",
                "community",
                "Enviar una despedida limpia cuando un integrante abandona la comunidad",
                conditions=("authorized_chat", "member_left"),
                inputs=("chat_id", "user_id"),
                outputs=("message_id",),
                actions=("telegram.send_message", "world.observe"),
                priority=70,
            ...
            p(
                ...
                "operator",
                "Unificar pedidos y medios en una vista priorizada por riesgo y urgencia",
                conditions=("media_staff",),
                inputs=("request_queue", "media_queue"),
                outputs=("prioritized_work_items", "next_actions"),
                actions=("db.read", "workflow.prioritize", "world.observe"),
                priority=100,
                cost=0.1,
            ),
            p(
