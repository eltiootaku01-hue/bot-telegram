...
class CardDefinition(Base):
    ...
    card_code: Mapped[str | None] = mapped_column(String(32), unique=True)
    character_id: Mapped[str] = mapped_column(String(100))
    ...
    source_provider: Mapped[str] = mapped_column(String(128), default="local")
    ...
    asset_width: Mapped[int | None] = mapped_column(Integer)
    asset_height: Mapped[int | None] = mapped_column(Integer)
    asset_mime_type: Mapped[str | None] = mapped_column(String(128))
